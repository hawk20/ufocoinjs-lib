...
var kpNetwork = ufocoin.networks.testnet
var keyPair = ufocoin.ECPair.fromWIF('cQqjeq2rxqwnqwMewJhkNtJDixtX8ctA4bYoWHdxY4xRPVvAEjmk', kpNetwork)
...
function fundAddress (unspents, outputs, callback) {
  ...
  var txb = new ufocoin.TransactionBuilder(kpNetwork)
